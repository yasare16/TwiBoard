...
public class TwiBoard extends Keyboard {
    ...
    public TwiBoard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }
    public TwiBoard(Context context, int layoutTemplateResId, 
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, 
        ...
        Key key = new TwiKey(res, parent, x, y, parser);
        if (key.codes[0] == 10) {
            mEnterKey = key;
        } else if (key.codes[0] == ' ') {
            mSpaceKey = key;
            ...
            mModeChangeKey = key;
            mSavedModeChangeKey = new TwiKey(res, parent, x, y, parser);
        } else if (key.codes[0] == TwiboardView.KEYCODE_LANGUAGE_SWITCH) {
            mLanguageSwitchKey = key;
            mSavedLanguageSwitchKey = new TwiKey(res, parent, x, y, parser);
        }
        return key;
    }
    /**
    ...
    void setImeOptions(Resources res, int options) {
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            case EditorInfo.IME_ACTION_GO:
                ...
                mEnterKey.icon = null;
                mEnterKey.label = res.getText(R.string.label_go);
                break;
            case EditorInfo.IME_ACTION_NEXT:
                mEnterKey.iconPreview = null;
                mEnterKey.icon = null;
                mEnterKey.label = res.getText(R.string.label_next);
                break;
            case EditorInfo.IME_ACTION_SEARCH:
                mEnterKey.icon = res.getDrawable(R.drawable.enter_key_search);
                mEnterKey.label = null;
                break;
            case EditorInfo.IME_ACTION_SEND:
                mEnterKey.iconPreview = null;
                mEnterKey.icon = null;
                mEnterKey.label = res.getText(R.string.label_send);
                break;
            default:
                mEnterKey.icon = res.getDrawable(R.drawable.enter_key_return);
                mEnterKey.label = null;
                break;
        }
    }
    ...
    static class TwiKey extends Keyboard.Key {
        
        public TwiKey(Resources res, Keyboard.Row parent, int x, int y,
                XmlResourceParser parser) {
